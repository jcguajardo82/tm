namespace ServicesManagement.Web.DAL
{
    ...
    public class DALPromocionesCostoEnvio
    {
        ...
        public static DataSet upCorpTms_Cns_CpEstados()
        {
            ...
            try
            {
                ...
                ds = Soriana.FWK.FmkTools.SqlHelper.ExecuteDataSet(CommandType.StoredProcedure, "[tms].[upCorpTms_Cns_CpEstados]", false);
        ...
        public static DataSet upCorpTms_Cns_CpCiudadesxEstado(string Region1Code)
        {
            DataSet ds = new DataSet();
            ...
            try
            {
                ...
                System.Collections.Hashtable parametros = new System.Collections.Hashtable();
                parametros.Add("@Region1Code", Region1Code);


                ds = Soriana.FWK.FmkTools.SqlHelper.ExecuteDataSet(CommandType.StoredProcedure, "[tms].[upCorpTms_Cns_CpCiudadesxEstado]", false, parametros);
